...
// Steps
// apiServer.js uses Express and json-server to serve mock data
// createMockDb.js will recreate the mock data each time we start the app
// mockData.js contains mock data (used for populating our mock database.)
// db.json is the fake database each time we start the app this file will be regenerated
